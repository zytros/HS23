...
img = skimage.io.imread('data/data_bow/cars-testing-pos/image_1155.png')
...
grad_direction = grad_direction % 180
hist_bins = numpy.array([10,32.5,55,77.5,100,122.5,145,167.5])
...
matplotlib.pyplot.bar(x=numpy.arange(8), height=HOG_cell_hist, align="center", width=0.8)
