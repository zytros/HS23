...
parser.add_argument("--model_path", default='runs/48557/last_model.pkl', type=str, help='path to the trained model, please change the default value to the path of your trained model')
